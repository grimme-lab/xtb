...
contains
   ...
   subroutine set_logicals(env, key)
      ...
      case default ! do nothing
        call env%warning("the key '"//key//"' is not recognized by scc", source)
      case ('nopocket')
         if (set1 == .true.) pocket_grid = .false.
         set1 = .false.
      case ('pocket')
         if (set2 == .true.) pocket_grid = .true.
         set2 = .false.
      case ('nostack')
         if (set3 == .true.) stack_grid = .false.
         set3 = .false.
      case ('stack')
         if (set4 == .true.) stack_grid = .true.
         set4 = .false.
      case ('noangular')
         if (set5 == .true.) angular_grid = .false.
         set5 = .false.
      case ('angular')
         if (set6 == .true.) angular_grid = .true.
         set6 = .false.
      case ('atm')
         if (set7 == .true.) fulle = .true.
         set7 = .false.
      case ('fast', 'qcg')
         if (set8 == .true.) then
      ...
      case ('noind')
         ...
         set9 = .false.
      case ('loose')
         if (set10 == .true.) mode = 2
         set10 = .false.
      case ('cs')
         if (set11 == .true.) cssym = .true.
         set11 = .false.
      case ('org')
         if (set12 == .true.) incl_org = .true.
         set12 = .false.
      case ('ensemble')
         if (set13 == .true.) docking_ens = .true.
         set13 = .false.
      case('attractive')
         if (set14 == .true.) directed_type = p_atom_att
         set14 = .false.
      case('repulsive')
         if (set15 == .true.) directed_type = p_atom_pot
         set15 = .false.
      end select
