...
*comdeck real.inc $Revision: 2002.3 $
     ...
     &          One2C2=0.2662567690426443D-04)
      ...
      IF (ABS(A).GT.One) Then
c         PRINT 3,A
c3        FORMAT(1X,'Warning argument of aCos= ',1F21.18)
         A=Sign(One,A)
      End If
*
      ArCos=ACos(A)
