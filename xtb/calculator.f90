...
subroutine peeq_calculation &
   ...
   ! get nuclear charges (without core)
   ...
   ! some post processing for the sigma tensor, since there is a lot of
   ! confusion in the literature regarding cell gradients, we have to decide
   ! for one, here I pick the cell gradients over the stress tensor
