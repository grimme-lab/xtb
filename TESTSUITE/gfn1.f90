...
subroutine test_gfn1_mindless_solvation
   ...
   real(wp), parameter :: ref_energies(10) = &
      ...
      & -35.787363117115_wp, -33.105134168602_wp, -21.425126566837_wp, &
      & -26.683086381488_wp]
   real(wp), parameter :: ref_gnorms(10) = &
      ...
      & 0.063361086949237_wp, 0.058990078376235_wp, 0.041889795619126_wp, &
   ...
   real(wp), parameter :: ref_hlgaps(10) = &
      ...
      & 2.6533136247624_wp, 1.3553349081282_wp, 4.0956047417239_wp, &
      & 1.3095666818230_wp]
