...
subroutine test_gfn1_mindless_cosmo
   ...
   character(len=*), parameter :: solvents(10) = [character(len=20) ::&
      ...
      & "ch2cl2", "ether", "methanol", "cs2", "dmso"]
   real(wp), parameter :: ref_energies(10) = &
      &[-33.050454233632_wp, -26.864884881693_wp, -25.822258679846_wp, &
      & -24.898679682800_wp, -29.039838134473_wp, -20.602456278350_wp, &
      & -35.757316028731_wp, -33.091933758843_wp, -21.418232077079_wp, &
      & -26.653093853751_wp]
   real(wp), parameter :: ref_gnorms(10) = &
      &[0.048144336682863_wp, 0.061276091807456_wp, 0.051252015155739_wp, &
      & 0.093096896046706_wp, 0.048721792575874_wp, 0.056078043358186_wp, &
      & 0.062663355660972_wp, 0.058087277901864_wp, 0.042056935039400_wp, &
      & 0.042560095851829_wp]
   real(wp), parameter :: ref_hlgaps(10) = &
      &[3.5120168534961_wp, 1.6750027662934_wp, 2.5009808719579_wp, &
      & 1.6590946164397_wp, 2.4208931461118_wp, 3.8024567155698_wp, &
      & 2.5998868038362_wp, 1.3547525878706_wp, 4.1071550938186_wp, &
      & 1.3798014560951_wp]
