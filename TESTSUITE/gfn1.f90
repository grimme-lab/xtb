...
subroutine test_gfn1_mindless_cosmo
   ...
   character(len=*), parameter :: solvents(10) = [character(len=20) ::&
      ...
      & "ch2cl2", "ether", "methanol", "cs2", "dmso"]
   real(wp), parameter :: ref_energies(10) = &
      &[-33.113210733469_wp, -26.894486386127_wp, -25.860692390998_wp, &
      & -24.912892480436_wp, -29.051418038545_wp, -20.622393882655_wp, &
      & -35.780883567444_wp, -33.116833700700_wp, -21.423322135506_wp, &
      & -26.670275272721_wp]
   real(wp), parameter :: ref_gnorms(10) = &
      &[0.07477887155484_wp, 0.06099939020245_wp, 0.05325038604322_wp, &
      & 0.10575604770386_wp, 0.04947013620198_wp, 0.05898114687602_wp, &
      & 0.05963833118098_wp, 0.06679518577110_wp, 0.04038964602644_wp, &
      & 0.04167919902811_wp]
   real(wp), parameter :: ref_hlgaps(10) = &
      &[3.7241057585822_wp, 1.7032426051771_wp, 2.4902920715056_wp, &
      & 1.6160157210374_wp, 2.1991003207500_wp, 3.5893833684067_wp, &
      & 2.8538523337649_wp, 1.3369214420073_wp, 4.1318603415274_wp, &
      & 1.5839694087811_wp]
