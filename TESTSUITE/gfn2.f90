...
subroutine test_gfn2_mindless_solvation
   ...
   real(wp), parameter :: ref_energies(10) = &
      ...
      & -33.448544467530_wp, -29.999546994410_wp, -20.567481283491_wp, &
      & -25.665458003353_wp]
   real(wp), parameter :: ref_gnorms(10) = &
      ...
      & 0.046463198340453_wp, 0.059014261993493_wp, 0.055081716352177_wp, &
   ...
   real(wp), parameter :: ref_hlgaps(10) = &
      ...
      & 2.6935601499212_wp, 0.82590501986159_wp, 3.3270919380043_wp, &
      & 0.3859217429034_wp]
